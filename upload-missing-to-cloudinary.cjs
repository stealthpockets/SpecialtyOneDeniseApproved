...
console.log('🔧 Cloudinary Config:', {
  cloud_name: process.env.VITE_CLOUDINARY_CLOUD_NAME ? '✅ Set' : '❌ Missing',
  api_key: process.env.VITE_CLOUDINARY_API_KEY ? '✅ Set' : '❌ Missing',
  api_secret: process.env.VITE_CLOUDINARY_API_SECRET ? '✅ Set' : '❌ Missing'
});
