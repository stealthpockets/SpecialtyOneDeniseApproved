...
const teamMembers = [
  {
    ...
    specialties: ["Manufactured Housing Communities", "RV Parks & Outdoor Hospitality", "1031 Exchange Strategy", "Complex Deal Structuring"],
    credentials: ["CCIM (Certified Commercial Investment Member)", "Licensed Real Estate Broker", "15+ Years CRE Experience"],
  ...
  },
  {
    ...
    specialties: ["Self-Storage Facilities", "Climate-Controlled Operations", "Value-Add Positioning", "Institutional Sales"],
    credentials: ["25+ Years Storage Industry Experience", "Licensed Real Estate Broker", "Former Storage Operator"],
...
const companyValues = [
  {
    ...
    description: "We don't chase headlines or awards. We close deals. Our success is measured by client outcomes, not marketing metrics."
  },
  {
    icon: <Shield size={32} className="text-white" />,
    title: "Confidentiality First",
    description: "Your business stays private until you decide otherwise. We protect seller confidentiality and buyer relationships with equal rigor."
  },
  {
    icon: <Users size={32} className="text-white" />,
    title: "Senior-Level Attention",
    description: "No handoffs to junior staff. Every client works directly with our principals who have skin in the game and decades of experience."
  },
  {
    icon: <Award size={32} className="text-white" />,
    title: "Specialized Expertise",
    description: "We focus exclusively on MH, RV, and Storage because specialization delivers superior results for our clients."
  }
];
...
const milestones = [
  {
    year: "2024",
    title: "Foundation",
    description: "Andrew Warner and Denise Nuñez establish Specialty One with decades of combined expertise"
  },
  {
    year: "2024",
    title: "Specialized Focus",
    description: "Launched with exclusive focus on manufactured housing, RV parks, and self-storage"
  },
  {
    year: "2024",
    title: "Proven Team",
    description: "Combined team experience of $1B+ in transactions across specialized asset classes"
  },
  {
    year: "2025",
    title: "Rapid Growth",
    description: "Expanding our exclusive buyer and seller networks while maintaining boutique service quality"
  }
];
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center text-sand">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              Manufactured Housing. RV Parks. Self-Storage.<br />
