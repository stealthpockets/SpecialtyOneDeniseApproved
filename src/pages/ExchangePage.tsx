...
const strategies = [
  {
    ...
    description: 'We structure tax-deferred sales that let you roll profits into new real estate—on your timeline, with the right buyer, and the right replacement asset. Strategy, timing, and execution—handled.'
  },
  {
    title: 'Delaware Statutory Trusts (DSTs)',
    icon: '🏢',
    heading: 'Passive income. Tax deferral. No management.',
    description: 'Exit active ownership and step into fractional interest in institutional-quality real estate. DSTs provide income, diversification, and total hands-off management.'
  },
  {
    title: '721 UPREIT Transactions',
    icon: '📈',
    heading: 'Convert property into liquidity.',
    description: 'Defer taxes by contributing your property into a REIT operating partnership. Gain exposure to a larger portfolio and receive partnership units with long-term liquidity and estate planning benefits.'
  }
];
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center text-sand">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              When you sell a property, capital gains don't have to become dead weight.
              We help MH, RV Park, and Self-Storage owners reinvest intelligently—minimizing taxes and maximizing control.
            </p>
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-8">
              We don't flood inboxes. We don't overpromise.
              We work deal-by-deal with owners who want clean, tax-aware exits—backed by experience, market knowledge, and execution.
            </p>
            <Button 
              to="/contact"
              variant="primary"
